...
prompt Note1: Session Information for this inspection
...
prompt Note2: Recycle Bin status for this inspection
...
prompt Description：
prompt Description:
prompt Used to check Oracle database metrics, including main parameters, objects, storage, performance (AWR, ASH, ADDM), and RMAN backup status.
...
prompt 
prompt +----------------------------------------------------------------------------+
prompt Execution will take several minutes depending on the database size.
...
prompt Please wait......
host echo start.....Setting environment variables and configuring HTML headers、ConfigurationhtmlTableHead....
...
SELECT CASE
         WHEN COUNT(1) > 0 THEN
          'CDB，PDB有' || COUNT(1) || '个，分别为：'||listagg(a.NAME,',') within group(order by a.CON_ID)
         ELSE
          '非CDB'
       END pdb
  FROM v$pdbs a;
...
SELECT case
       ...
       case
         WHEN d.VALUE is null then
          '本Libraries未ConfigurationDGEnvironment'
         else
          d.VALUE
       end DGINFO2
  FROM v$parameter d
...
--       500485760   lie_v_plan_cost, --cost 花费
--       514600000   lie_v_PLAN_CARDINALITY, --预估行数
--       18000000000 lie_V_ELAPSED_TIME, ---执行Time，例执行Timesettings5小时，则： 5h*60*60*1000000
--       10000       lie_v_EXECUTIONS --执行Times
--  FROM dual;
...
head ' -
  <title>&_dbname1 InspectionReport</title> -
  <style type="text/css"> -
...
<tr><th colspan="6"><a class="info" href="#database_check_overview"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#ffffff"><b>(I) Inspection Service Overview</b></font></a></th></tr> -
<tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_ztgk"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>Database General Overview</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#basic_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Basic Database Info<span>DatabaseLibraries的总体概况、DG、OGG、Version、PSU、HostOverview、DatabaseLibrariesLoadOverview、DatabaseLibraries属性等</span></font></a></td> -
...
<td nowrap align="center" width="18%"><a class="info" href="#db_option_REGISTRY"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Components and Features<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#dba_libraries_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Libraries<span>Libraries</span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#spfile_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>Parameter Files</b><span> </span></font></a></td> -
...
<td nowrap align="center" width="18%"><a class="info" href="#initial_parameter_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Critical Parameters<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#Implicit_parameters"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Hidden Parameters<span>一般的系统Hidden Parameters的Default Value不能修改</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#spfile_contents"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">spfileFileContent<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#statistics_level"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Statistics Level<span>Statistics级别</span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
...
<td nowrap align="center" width="18%"><a class="info" href="#tablespaces_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">TableSpace状况Info<span>包含TableSpace的历史增长Overview</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#flash_usage"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Flashback Usage<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#ts_temp_usage"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Temporary Tablespace Usage<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#ts_undo_usage"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Undo Tablespace Usage<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#ts_tu_aflag"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Undo Segments、Temporary Segments扩展Overview<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#data_files"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Data Files状况<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#control_files_all"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">控制File<span>Control Files</span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_asmdiskcheck"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>ASMDiskMonitor</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#asm_disk"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">ASMDiskUsage<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#asm_diskgroup"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">ASMDiskGroupUsage<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#asm_diskgroupATTRIBUTE"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">ASMDiskGroupParameterConfiguration Settings<span> </span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_jobs_yxqk"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>JOBOverview</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#jobs_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">JobExecution状况<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#jobs_info_errores"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DatabaseLibrariesjob报错Info<span>近一周内的Errors</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
...
<tr><th colspan="6"><a class="info" href="#check_detail"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#ffffff"><b>（二）InspectionServiceDetails</b></font></a></th></tr> -
<tr style="background:#FFFFCC;"> -
...
<td nowrap align="center" width="18%"><a class="info" href="#rman_backup_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">RMANBackup状况<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#rman_configuration"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">RMANConfiguration Settings<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#rman_all_backupsetinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">RMANAllBackup<span>RMANAllBackup概况</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#rman_backupset_detail_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">RMANAllBackupDetails<span>RMANAllBackupDetails，排除Archiving Information</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#rman_backup_control_files"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">控制FileBackup<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#rman_backup_spfile"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">spfileFileBackup<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#rman_backup_archivedlog"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">RMANArchivingFileBackup<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#flashback_database_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DatabaseLibrariesFlashback<span>Flashback Technologies</span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="2"  nowrap align="center" width="10%"><a class="info" href="#database_archiveloginfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>Archiving Information</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#archiving_instance_parameters"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Archiving日志settings<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#archiving_history"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Archiving日志生成Overview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#archive_log_rate"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Archiving日志占用率<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#log_10_ratefenxi"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">近7天日志切换频率分析<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#log_10_ratefenxiqiehuan"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Daily Log Switch Frequency<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#logsize"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">日志Group大小<span> </span></font></a></td> -
...
<td nowrap align="center" width="18%"><a class="info" href="#sga_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">SGA Usage<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sga_information"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">SGA ConfigurationInfo<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sga_target_advice"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">SGA AdvisorConfiguration<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sga_asmm_dynamic_components"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">SGA Dynamic Components<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#pga_target_advice"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">PGA TARGET AdvisorConfiguration<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
...
<td nowrap align="center" width="18%"><a class="info" href="#file_io_statistics"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">FileIO分析<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#file_io_timings"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">FileIOTime分析<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#full_table_scans"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">FullTableScanOverview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sorts"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">SortOverview<span> </span></font></a></td> -
...
<td nowrap align="center" width="18%"><a class="info" href="#sql_statements_with_most_buffer_gets"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top 10 SQL by Buffer Gets<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_statements_with_most_disk_reads"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top 10 SQL by Disk Reads<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_statements_ELAPSED_TIMEtop10"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top 10 SQL by Execution Time<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_statements_execute10"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top 10 SQL by Elapsed Time<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_statements_parse10"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top 10 SQL by Parse<span> Top 10 SQL by Parse</span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_statements_version_count10"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top 10 by Version Counts<span>SQL ordered by Version Count</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_statements_with_most_sharable_mem"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top 10 SQL by Memory<span>针对shared memory占用的Overview进行Sort，记录了SQL占用library cache的大小的TOP SQL</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#disksortmax_sql"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top SQL by Disk Sorts<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#ashmax_sql"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">FromASHViewQuerySQL<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#running_rubish_sql_11g"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Inefficient SQL (Running - 11g)<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#running_rubish_sq1_10g"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Inefficient SQL RUNNING_10G<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#awr_last_sql_infoall"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">LAST Snapshot SQL Overview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_elasled_lastlongsql"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Longest Running SQL in Last Snapshot<span>在最新的一个 Snapshot中，取执行Time最长的一个SQL</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_elasled_lastsql_monitor"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top SQL by Elapsed Time<span>在gv$sql_monitor中，按照TimeSort取10条记录</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_elasled_lastlongsqlreport"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Top SQL Execution Time <span>在GV$SQL_MONITOR中，取执行Time最长的一个SQL</span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#sql_no_bind"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">SQL Queries Without Bind Variables<span>Check SQL Queries Without Bind Variables</span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#link_dba_flashback_archive"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>FlashbackArchiving</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_dba_flashback_archiveinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">FlashbackArchivingConfiguration<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_dba_flashback_archive_tables"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">EnabledFlashbackArchiving的表<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_dba_flashback_archive_ts"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Flashback & Archiving Space<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#link_dginfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>DGLibraries</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_dg_config"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DGLibrariesConfiguration Settings<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_dg_runinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DGLibrariesExecutionOverview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_dg_runprocessinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">主LibrariesDGProcess<span>包含主Libraries和备Libraries的Process</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_dg_standbylog"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">主Librariesstandby日志<span>包含主Libraries和备Libraries的standby日志(SRL)</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_dg_redoapplyinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">备Libraries日志应用Overview<span>备Libraries日志应用Overview及应用ProcessErrors提示</span></font></a></td> -
</tr>
prompt </table>
...
<tr><th colspan="6"><a class="info" href="#database_security"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#ffffff"><b>（三）DatabaseLibraries安全</b></font></a></th></tr> -
<tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="2"  nowrap align="center" width="10%"><a class="info" href="#database_userinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>DatabaseLibrariesUser</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#user_accounts"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DatabaseLibrariesUser一览<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#users_with_dba_privileges"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">拥有DBA角色的User<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#users_with_sys_privileges"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">拥有SYS角色的User<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#roles"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">角色概况<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#default_passwords"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">密码为系统Default Value的User<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#user_size"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">整个User有多大<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#user_logon_error"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">近一周登录Errors的User<span> </span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_systemuserinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>系统TableSpaceUser</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#users_with_default_tablespace_defined_as_system"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">SYSTEM为缺省TableSpace的User<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#users_with_default_temporary_tablespace_as_system"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">SYSTEM为临时TableSpace的User<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#objects_in_the_system_tablespace"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">系统TableSpace上的对象<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> - 
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_audit"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>DatabaseLibraries审计</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#database_audit_parameter"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">审计ParameterConfiguration<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#database_audit_table_parameter"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">审计表Overview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#database_audit_all"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DB中All审计记录<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> - 
</tr>
prompt </table>
...
<tr><th colspan="6"><a class="info" href="#db_objects"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#ffffff"><b>（四）DatabaseLibraries对象</b></font></a></th></tr> -
<tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="2"  nowrap align="center" width="10%"><a class="info" href="#database_segmentsinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>段Overview</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#object_summary"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">对象汇总<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#segment_summary"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">段的汇总<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#top_10_segments_by_size"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">体积最大的10个段<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#top_10_segments_by_extents"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">扩展最多的10个段<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#dba_lob_segments"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">LOB段<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#objects_unable_to_extend"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">不能扩展的对象<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#objects_which_are_nearing_maxextents"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">扩展超过1/2最大扩展度的对象<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#undo_Segments_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Undo 段<span>Undo 段</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#tablespace_to_owner"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">TableSpaceOwner<span> </span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_tablesallinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>表Overview</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#tables_suffering_from_row_chaining_migration"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">行链接或行迁移的表<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#tables_10Wnopkey"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">超过10W行无主键的表<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#tables_nodata"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">无Database有高水位的表<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_parttableinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>分区表Overview</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#nopart_table10g"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">表大小超过10GB未建分区<span>表超过10GB未建分区的表</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#objects_max10"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">分区最多的前10个对象<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#partsum100"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">分区Count超过100个的表<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_invalidobjects"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>Invalid Objects</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#invalid_objects"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">无效的对象<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#UNUSABLE_index"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">无效的普通Index<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#UNUSABLE_partindex"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">无效的分区Index<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#disabled_triggers"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">无效的触发Server<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="2"  nowrap align="center" width="10%"><a class="info" href="#database_indexinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>IndexOverview</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#num_index_5"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Tables with More Than 5 Indexes<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#size_table_2"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">大表未建Index<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#jxdl_index"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Group合Index与单列Index存在交叉<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#bitmap_func_index"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">位图Index和函数Index<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#noindex_wjkey"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">外键未建Index<span>表外键无Index易引起死锁</span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#big_index_never_use"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">大IndexFrom未使用<span>大于1M的Index在 Snapshot期间内From未使用过</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#index_cols_counts"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Index列Count大于3<span>复合IndexIndex列的Count一般为3个，超过3个需要Check其合理性 </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#index_cols_high"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Index高度大于3<span>Index的高度大于3的时候需要考虑If重建Index</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#index_cols_STALE_STATS"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Index的StatisticsInfo过旧<span>Index的StatisticsInfo过旧</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_parallelinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>并行度</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#table_parallel"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">表带有并行度<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#index_parallel"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Index带有并行度<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="2"  nowrap align="center" width="10%"><a class="info" href="#database_othersobjects"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>其他对象</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_alert_log"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">告警日志<span>包括： 最新的2000行告警日志记录、最新的10条ora告警日志记录、告警日志File预估大小</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#dba_directories"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DatabaseLibrariesDirectory<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#dba_recycle_bin"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">回收站Overview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#db_links"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DatabaseLibraries链路(db_link)<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#link_external_tables"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">外部表<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#all_triggers_show"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">All的触发Server<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sequence_cache_20"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">序列cache小于20<span>一般Overview下将其增至1000左右，序列默认的20太小了</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#dba_mviews_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">物化View<span> </span></font></a></td> -
...
prompt </table>
prompt <table width="100%" border="1" bordercolor="#000000" cellspacing="0px" style="border-collapse:collapse; margin-top:-2.8cm;" align="center"> -
<tr><th colspan="6"><a class="info" href="#database_performacefenxi"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#ffffff"><b>(V) Database Libraries Performance Analysis</b></font></a></th></tr> -
<tr style="background:#FFFFCC;"> -
...
<td nowrap align="center" width="18%"><a class="info" href="#awr_snapshot_settings"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">AWRParameterConfiguration状况<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#awr_host_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">DatabaseLibrariesServiceServerHost的Overview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#awr_loadprofile"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">AWRView中的load profile<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#hot_blocks_summary"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">热块<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#awr_new_lastone"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">最新的一次AWR报告<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
...
<td nowrap align="center" width="18%"><a class="info" href="#ash_snapshot_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">ASH Snapshot状况<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#ash_lastone_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">最新的一次ASH报告<span> </span></font></a></td> -
...
<td nowrap align="center" width="18%"><a class="info" href="#ADDM_snapshot_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">最新的一次ADDM<span> </span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_tjxinxiinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>StatisticsInfo</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#statics_gatherflag"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">StatisticsInfoIf自动收Set<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#statics_gatherfla_table"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">需收SetStatisticsInfo的表<span>From未收Set过StatisticsInfo的表或者1个月内没有收Set过StatisticsInfo的表</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#statics_gatherfla_tmptable"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">被收SetStatisticsInfo的临时表<span>临时表不Advisor收SetStatisticsInfo</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#statics_gatherlock"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">StatisticsInfo被锁的表或Index<span>Query哪些表或Index的StatisticsInfo被锁了</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="2"  nowrap align="center" width="10%"><a class="info" href="#database_sessionsinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>会话</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#current_sessions"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">会话概况<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#user_session_matrix"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">会话状态一览(Current)<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#user_session_active_his"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">历史ACTIVE会话数<span> </span></font></a></td> - 
<td nowrap align="center" width="18%"><a class="info" href="#session_long_run"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">登录Time最长的10个会话<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#long_nofanying"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">超过10小时无响应的会话<span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td nowrap align="center" width="18%"><a class="info" href="#session_commit_max"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">CommitTimes最多的会话<span> </span></font></a></td> - 
<td nowrap align="center" width="18%"><a class="info" href="#long_cpuwait"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">CPU或等待最长的会话<span> </span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_lockinfoall"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>锁</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#look_lock"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">CheckLOCK锁Overview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#look_lock_whowho"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">CheckWho锁住了Who<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#open_cursor_details"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">CursorUsage<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#spid_completeinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">并行Process完成Overview<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#spid_completeinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
</tr>
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_memoryinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>Memory占用</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#rate_db_object_cache"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Query共享Memory占有率<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#pga_max_spid"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">PGA占用最多的Process<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#db_ratiosssa"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">命中率<span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
...
prompt <tr style="background:#FFFFCC;"> -
<td style="background-color:#FFCC00" rowspan="1"  nowrap align="center" width="10%"><a class="info" href="#database_waitallinfo"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#000000"><b>其它</b><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#wait_event_current"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">WaitEvent<span>包括现在、历史、按照snap_id分Group等</span></font></a></td> -
...
<tr><th colspan="6"><a class="info" href="#health_check_summary_info"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#ffffff"><b>（六）Health Check Results</b></font></a></th></tr> -
<tr style="background:#FFFFCC;"> -
...
<td nowrap align="center" width="18%"><a class="info" href="#health_check_summary_info_details"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">Health Check Results<span>由于该脚本Content检测过于详细,所以该部分将对HealthCheck报告进行过滤，过滤出有问题的部分</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#sqlscripts_errors"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699">HealthCheck过程中脚本产生的Errors<span>该部分Content不属于HealthCheck报告的Content，只作为执行者调试脚本使用，个别报错属于正常现象</span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> -
<td nowrap align="center" width="18%"><a class="info" href="#"><font size=+0.5 face="Courier New,Helvetica,sans-serif" color="#336699"><span> </span></font></a></td> - 
</tr>
...
-- +====================================================================================================================+
-- |
-- | <<<<<     DatabaseLibrariesInspectionServiceOverview     >>>>>                                         |
-- |                                                                                                                    |
-- +====================================================================================================================+

host echo  start...DatabaseLibrariesInspectionServiceOverview. . 


prompt <a name="database_check_overview"></a>
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b><u>DatabaseLibrariesInspectionServiceOverview</u></b></font></center>
prompt <p>


host echo "            Database General Overview. . ." 
prompt <a name="database_ztgk"></a>
prompt <font size="+2" color="00CCFF"><b>Database General Overview</b></font><hr align="left" width="800">
prompt <p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Basic Database Info</b></font><hr align="left" width="600">
...
<tr><th align="left" width="150">Report Filename</th><td width="950"><font face="Courier New">&_reporttitle..html</font></td></tr> -
<tr><th align="left" width="150">Inspection Time</th><td width="950"><font face="Courier New">&_date_time_timezone</font></td></tr> -
<tr><th align="left" width="150">Current User</th><td width="950"><font face="Courier New">&_v_current_user</font></td></tr> -
<tr><th align="left" width="150">Current Session</th><td width="950"><font face="Courier New">&_v_sessionid</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibrariesServiceServerConfiguration Settings</th><td width="950"><font face="Courier New">&_hostinfo</font></td></tr> -
<tr><th align="left" width="150">OS Information</th><td width="950"><font face="Courier New">&_platform_name / &_platform_id</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibrariesName</th><td width="950"><font face="Courier New">&_dbname</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibrariesGlobalName</th><td width="950"><font face="Courier New">&_global_name</font></td></tr> -
<tr><th align="left" width="150">CurrentInstanceName</th><td width="950"><font face="Courier New">&_instance_name</font></td></tr> -
<tr><th align="left" width="150">AllInstanceName</th><td width="950"><font face="Courier New">&_instance_name_all</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibrariesVersion</th><td width="950"><font face="Courier New">&_dbversion</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibrariesID(DBID)</th><td width="950"><font face="Courier New">&_dbid</font></td></tr> -
<tr><th align="left" width="150">Is RAC / Node Count</th><td width="950"><font face="Courier New">&_rac_database</font></td></tr> -
<tr><th align="left" width="150">Is CDB / PDB Count</th><td width="950"><font face="Courier New">&_pdbs</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibrariesCreationTime</th><td width="950"><font face="Courier New">&_creation_date</font></td></tr> -
...
<tr><th align="left" width="150">DatabaseLibrariesArchivingMode</th><td width="950"><font face="Courier New">&_log_mode</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibrariesFlashback状态</th><td width="950"><font face="Courier New">&_FLASHBACK_ON</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibraries字符Set</th><td width="950"><font face="Courier New">&_characterset</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibraries块大小</th><td width="950"><font face="Courier New">&_blocksize</font></td></tr> -
<tr><th align="left" width="150">Force日志</th><td width="950"><font face="Courier New">&_FORCE_LOGGING</font></td></tr> -
<tr><th align="left" width="150">DatabaseLibraries角色</th><td width="950"><font face="Courier New">&_DB_ROLE</font></td></tr> -
<tr><th align="left" width="150">If有DG</th><td width="950"><font face="Courier New">&_DGINFO</font></td></tr> -
<tr><th align="left" width="150">If有OGG</th><td width="950"><font face="Courier New">&_GGS_GGSUSER_ROLE</font></td></tr> -
<tr><th align="left" width="150">db time zone</th><td width="950"><font face="Courier New">&_timezone</font></td></tr> -
<tr><th align="left" width="150">回收站Overview</th><td width="950"><font face="Courier New">&_recyclebin1</font></td></tr> -
<tr><th align="left" width="150">特殊Tablespace Status(G)</th><td width="950"><font face="Courier New">&_TS_DELETE</font></td></tr> -
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibraries系统VersionInfo</b></font><hr align="left" width="450">

CLEAR COLUMNS COMPUTES
SET DEFINE OFF

COLUMN banner   FORMAT a300   HEADING 'DatabaseLibraries系统VersionInfo'
...
prompt <a name="database_version"></a>
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibraries系统PSUInfo</b></font><hr align="left" width="450">
...
prompt <a name="database_version"></a>
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 私网网卡Info</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibrariesInstance状况</b></font><hr align="left" width="450">

CLEAR COLUMNS COMPUTES
SET DEFINE OFF


COLUMN instance_name_print       FORMAT a75    HEADING 'DatabaseLibrariesInstanceName'       ENTMAP OFF
COLUMN instance_number_print     FORMAT a75    HEADING 'DatabaseLibrariesInstance号'        ENTMAP OFF
COLUMN thread_number_print                     HEADING 'Thread Number'          ENTMAP OFF
COLUMN host_name_print           FORMAT a75    HEADING 'HostName'           ENTMAP OFF
COLUMN version                                 HEADING 'DatabaseLibrariesVersion'      ENTMAP OFF
COLUMN START_TIME                FORMAT a75    HEADING 'Instance Startup Time'          ENTMAP OFF
COLUMN uptime                                  HEADING 'ExecutionTime(天)'    ENTMAP OFF
COLUMN parallel                  FORMAT a75    HEADING 'RACMode'    ENTMAP OFF
COLUMN instance_status           FORMAT a75    HEADING 'Instance状态'     ENTMAP OFF
COLUMN database_status           FORMAT a75    HEADING 'DatabaseLibraries状态'     ENTMAP OFF
COLUMN logins                    FORMAT a75    HEADING 'If logins'              ENTMAP OFF
COLUMN archiver                  FORMAT a75    HEADING 'If Archiving'            ENTMAP OFF
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibrariesOverview</b></font><hr align="left" width="450">
...
COLUMN log_mode                                       HEADING '日志Mode'                   ENTMAP OFF
...
COLUMN flashback_on                                   HEADING 'IfFlashback?'              ENTMAP OFF
COLUMN controlfile_type                               HEADING '控制FileType'           ENTMAP OFF
...
FROM   gv$database d;
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>]</center><p>




prompt <a name="pdb_overview"></a>
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● PDBOverview</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibrariesServiceServerHost的Overview</b></font><hr align="left" width="450">
...
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>] [<a class="noLink" href="#initial_parameter_info">下一项</a>]</center>


prompt <a name="DB_LOAD_PROFILE"></a>
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibrariesLoadOverview</b></font><hr align="left" width="450">

CLEAR COLUMNS COMPUTES
SET DEFINE OFF
SET DEFINE ON

prompt <center>[<a class="noLink" href="#awr_loadprofile"><font size=+1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：AWRView中的load profile</b></font></a>]</center><p>
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibraries属性</b></font><hr align="left" width="450">
...
prompt <b><font face="Courier New,Helvetica,Geneva,sans-serif" color="#990000">NOTE</font></b>: 可以同时RefrenceTableSpace部分Content  [<a class="noLink" href="#tablespaces_info">TableSpaceInfo</a>]

CLEAR COLUMNS COMPUTES
SET DEFINE OFF


prompt ● ts_datafile_physical_size_G表示AllTableSpace的物理File实际占用大小，即TableSpace大小（不包括tempTableSpace）
prompt ● ts_tempfile_physical_size_G表示All临时TableSpace的File实际占用大小
prompt ● ts_datafile_used_size_G表示AllTableSpace的使用大小，Data Files实际使用大小，RMAN非压缩Backup大小（若使用压缩as compressedBackup则至少可以减少一半空间）
...
--COLUMN sum3        FORMAT  999,999,999,999,999                   HEADING 'dmp全Backup约(G)'
--COLUMN sum1        FORMAT  999,999,999,999,999                   HEADING 'RMAN全Backup约(G)'
--COLUMN sum2        FORMAT  999,999,999,999,999                   HEADING 'Data Files容量(G)'
...
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>]</center>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Current客户端Info</b></font><hr align="left" width="600">
...
COLUMN RESOURCE_NAME        FORMAT a75    HEADING ' ResourcesName'    ENTMAP OFF	
COLUMN CURRENT_UTILIZATION  FORMAT 999,999,999,999,999    HEADING 'Current Value'      ENTMAP OFF
COLUMN MAX_UTILIZATION		  FORMAT 999,999,999,999,999    HEADING '最大Value'      ENTMAP OFF
COLUMN INITIAL_ALLOCATION   FORMAT 999,999,999,999,999    HEADING '初始Value'      ENTMAP OFF
COLUMN LIMIT_VALUE          FORMAT 999,999,999,999,999    HEADING '限制Value'      ENTMAP OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Components and Features</b></font><hr align="left" width="600">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Feature Usage Statistics</b></font>[<a class="noLink" href="#high_water_mark_statistics">下一项</a>] <hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Libraries</b></font>[<a class="noLink" href="#spfile_info">下一项</a>] <hr align="left" width="600">
...
prompt <font size="+2" color="00CCFF"><b>Parameter Files</b></font><hr align="left" width="800">
prompt <p>



prompt <a name="initialization_parameters"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>All Initialization Parameters</b></font>  [<a class="noLink" href="#initial_parameter_info">下一项</a>] <hr align="left" width="600">
...
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>] [<a class="noLink" href="#initialization_parameters">上一项</a>]</center><p>
...
prompt PDB的Parameter存储在 CDB 的 PDB_SPFILE$ 字典表中以 con_id 区别，所以， PDB 的 PDB_SPFILE$ 表是空的，也可以通过QueryV$SYSTEM_PARAMETER获取
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Critical Parameters</b></font><hr align="left" width="600">
...
COLUMN pname                FORMAT a75    HEADING 'ParameterName'    ENTMAP OFF
COLUMN instance_name_print  FORMAT a45    HEADING 'InstanceName'     ENTMAP OFF
COLUMN value                FORMAT a75    HEADING 'ParameterValue'             ENTMAP OFF
...
prompt <a name="Implicit_parameters"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Hidden Parameters</b></font></center><p> <hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>TableSpace状况</b></font><hr align="left" width="600">
...
COLUMN name                                    HEADING '表Area Name'   ENTMAP OFF
COLUMN type        FORMAT a12                  HEADING 'TableSpaceType'           ENTMAP OFF
COLUMN extent_mgt  FORMAT a12                  HEADING '扩展管理方式'         ENTMAP OFF
COLUMN segment_mgt FORMAT a12                   HEADING '段管理方式'         ENTMAP OFF
COLUMN ts_size     FORMAT 999,999,999,999,999  HEADING 'TableSpace大小(MB)'   ENTMAP OFF
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● SYSAUXTableSpaceUsageDetails</b></font><hr align="left" width="450">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>TableSpace日增长量（Database Growth）</b></font><hr align="left" width="500">

prompt <font size="1" face="Courier New,Helvetica,Geneva,sans-serif" color="#990000">NOTE: 可根据Viewcdb_hist_seg_stat和cdb_hist_seg_stat_obj详细分析DatabaseLibraries对象的增量Overview</font>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b> DatabaseLibrariesFlashback Usage</b></font><hr align="left" width="600">
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibrariesFlashback空间总体Usage</b></font><hr align="left" width="450">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibrariesFlashback空间详细Usage</b></font><hr align="left" width="450">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b> Temporary Tablespace Usage</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b> Undo Tablespace Usage</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF

SELECT r.name Undo SegmentsName, rssize/1024/1024/1024 "RSSize(G)",
  s.sid,
  s.serial#,
  s.username UserName,
  s.status,
  ...
  s.MACHINE,
  s.MODULE,
  substr(s.program, 1, 78) OS PROGRAM,
  r.usn,
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Monitor Undo Segments，Temporary Segments Extension Overview</b></font><hr align="left" width="450">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,Geneva,sans-serif" color="#990000">NOTE</font>:<font color="red"> Undo和TempTableSpace不Advisorsettings为自动扩展</font> </font></b>
prompt 

prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Undo Segments</b></font><hr align="left" width="450">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Temporary Segments</b></font><hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Data Files状况</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 控制File(Control Files) </b></font><hr align="left" width="600">
...
--------------------------------------------------------------------------------------------------------------------------------------
--------------------------------------------------------------------------------------------------------------------------------------
host echo "            ASMDiskMonitor. . ." 

prompt <a name="database_asmdiskcheck"></a>
prompt <font size="+2" color="00CCFF"><b>ASMDiskMonitor</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="asm_disk"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>ASMDiskUsage</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>ASMDiskGroupUsage</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>ASMDiskGroupParameterConfiguration Settings</b></font>[<a class="noLink" href="#asm_diskgroupinstance">下一项</a>]<hr align="left" width="600">
...
host echo "            JOBOverview. . ." 
prompt <a name="database_jobs_yxqk"></a>
prompt <font size="+2" color="00CCFF"><b>JOBOverview</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="jobs_info"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>JobExecution状况</b></font><hr align="left" width="600">
...
COLUMN what       FORMAT a100            HEADING 'JobContent'             ENTMAP OFF
COLUMN next_date   FORMAT a140    HEADING '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;NextExecutionTime&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'  ENTMAP OFF
COLUMN interval   FORMAT a100             HEADING '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Interval&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'         ENTMAP OFF
COLUMN last_date   FORMAT a140    HEADING '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;上一次ExecutionTime&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'  ENTMAP OFF
COLUMN failures   FORMAT a75             HEADING 'FailureTimes'         ENTMAP OFF
COLUMN broken     FORMAT a75             HEADING 'IfBroken？'          ENTMAP OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DatabaseLibrariesjob报错Info</b></font> [<a class="noLink" href="#database_rmanbackinfo">下一项</a>]<hr align="left" width="600">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: Check近一周内，Everyjob取最新的3条Errors </font></b>
...
-- +====================================================================================================================+
-- |
-- | <<<<<     DatabaseLibrariesInspectionServiceDetails     >>>>>                                         |
-- |                                                                                                                    |
-- +====================================================================================================================+


   
host echo  start...DatabaseLibrariesInspectionServiceDetails. .
prompt <p>
prompt <a name="check_detail"></a>
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b><u>DatabaseLibrariesInspectionServiceDetails</u></b></font></center>
prompt <p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>RMANBackup状况</b></font><hr align="left" width="600">
...
COLUMN backup_name           FORMAT a130   HEADING 'BackupName'          ENTMAP OFF
COLUMN START_TIME            FORMAT a75    HEADING 'StartTime'           ENTMAP OFF
COLUMN elapsed_time          FORMAT a75    HEADING '花费Time'         ENTMAP OFF
COLUMN status                              HEADING '状态'               ENTMAP OFF
COLUMN input_type                          HEADING '输入Type'           ENTMAP OFF
...
prompt <b><font face="Courier New,Helvetica,Geneva,sans-serif" >● RMANBackup效率</font></b>
prompt ● Monitor  type 列为 'aggregate' 的 EPS 列Value，If EPS 列的Value远小于Backup硬件读写速率Value，就应当查找BackupProcess中的问题 
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>RMAN Configuration</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>RMANAllBackup</b></font>[<a class="noLink" href="#rman_backupset_detail_info">下一项</a>]<hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>RMANAllBackupDetails</b></font>[<a class="noLink" href="#rman_backup_sets">下一项</a>]<hr align="left" width="600">
prompt <font size="1" face="Courier New,Helvetica,Geneva,sans-serif" color="#990000">NOTE: 排除Archiving Information</font>
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>RMANBackupSet</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>RMANBackup片</b></font><hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>RMAN 控制FileBackup</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>RMAN ArchivingFileBackup</b></font>[<a class="noLink" href="#flashback_database_info">下一项</a>]<hr align="left" width="600">
...
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b><u>Flashback Technologies(DatabaseLibrariesFlashback)</u></b></font></center>
...
-- |                             - ARCHIVING MODE -                             |
-- +----------------------------------------------------------------------------+
host echo "            Archiving Information. . ." 
prompt <a name="database_archiveloginfo"></a>
prompt <font size="+2" color="00CCFF"><b>Archiving Information</b></font><hr align="left" width="800">
prompt <p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>ArchivingParameterConfiguration Settings</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Archiving日志生成Overview</b></font><hr align="left" width="600">

prompt <a name="archiving_history_all"></a>
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 近一个月Archiving日志Overview </b></font><hr align="left" width="450">

CLEAR COLUMNS COMPUTES
SET DEFINE OFF


COLUMN thread#          FORMAT a79                   HEADING 'InstanceName'           ENTMAP OFF
COLUMN f_time           FORMAT a75                   HEADING 'Archiving日期'           ENTMAP OFF
COLUMN day_arch         FORMAT 999,999,999,999,999   HEADING '每天Archiving日志量(MB)'   ENTMAP OFF
COLUMN hour_arch         FORMAT 999,999,999,999,999   HEADING 'Hourly平均Archiving日志量(MB)'   ENTMAP OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Archiving日志占用率</b></font><hr align="left" width="600"> 
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 进而Monitor DB_RECOVERY_FILE_DEST_SIZEParameter，后续可以考虑crosscheck archivelog all; delete expired archivelog all;</font></b>
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 若Archiving日志没有放在Flashback恢复区，则需要去CheckServiceServer的空间</font></b>
CLEAR COLUMNS COMPUTES
SET DEFINE ON
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>近7天日志切换频率分析</b></font> [<a class="noLink" href="#log_10_ratefenxiqiehuan">下一项</a>]<hr align="left" width="600">
prompt <font face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 注意Monitor 各行里first_time之间的Time差异会不会很短，很短就是切换过频繁，取top500</font>
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Daily Log Switch Frequency</b></font><hr align="left" width="600">
prompt <font face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 近一月内Daily Log Switch Frequency，即可分析30天的波度，又可分析24小时内，可很容易看出异常Overview</font>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>日志Group大小</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>SGAUsage</b></font><hr align="left" width="600">
...
COLUMN resizeable		  FORMAT a75   HEADING 'If可调'      ENTMAP OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>SGA ConfigurationInfo</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>SGA (ASMM) DynamicComponents</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>PGA Target Advisor</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>FileIO分析</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>FileIOTime分析</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Full Table Scan Statistics</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>SortOverviewStatistics</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Buffer GetsTOP10的SQLQuery</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Disk ReadsTOP10的SQLQuery</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>执行TimeTOP10的SQLQuery</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Top 10 SQL by Elapsed TimeSQLQuery</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>ParseTimesTOP10的SQLQuery</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>VERSION_COUNT TOP10的SQLQuery</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Top 10 SQL by Memory</b></font><hr align="left" width="600">

prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 针对shared memory占用的Overview进行Sort，记录了SQL占用library cache的大小的TOP SQL </font></b>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DISK_SORT严重的SQL</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>FromASHViewQuerySQL</b></font><hr align="left" width="600">
...
prompt ● TopIntensiveCPU的SQLQuery
...
prompt ● TopIntensiveI/O的SQLQuery
SELECT ASH.INST_ID,
       ASH.SQL_ID,
       (SELECT VS.SQL_TEXT
          FROM GV$SQLAREA VS
...
prompt ● Resource Intensive SQL Queries
SELECT ASH.INST_ID,
       ASH.SQL_ID,
       (SELECT VS.SQL_TEXT
          FROM GV$SQLAREA VS
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Inefficient SQL (Running - 11g)</b></font><hr align="left" width="600">
...
SELECT T.INST_ID,
       ...
       T.ASH_COUNTS,
       T.SESSION_INFO,
       '系统预估的剩余执行Time过长【' || ROUND(D.TIME_REMAINING) || '】' MONITOR_TYPES
...
SELECT T.INST_ID,
       ...
       T.ASH_COUNTS,
       T.SESSION_INFO,
       'WaitEvent异常【' || T.EVENT || '】' MONITOR_TYPES
  FROM TMPS T
...
SELECT T.INST_ID,
       ...
       T.ASH_COUNTS,
       T.SESSION_INFO,
       'SQL占用TMPTableSpace过大【' || C.BYTES || '】Bytes' MONITOR_TYPES
  FROM TMPS T,
...
UNION ALL
-----------------------------------------  SQL占用UNDO过大，INACTIVE的会话也可能占用UNDO，但是这里只记录正在Execution的SQLQuery
...
SELECT T.INST_ID,
       ...
       T.ASH_COUNTS,
       T.SESSION_INFO,
       'ASH捕获的Times【' || T.ASH_COUNTS || '】【'||SESSION_STATE||'】'  MONITOR_TYPES
  FROM TMPS T
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>LAST Snapshot中SQLOverview</b></font><hr align="left" width="600">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 该部分Content拷贝到Excel中，根据执行Time、Disk Reads、Buffer Gets等列进行Sort来分析</font></b>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Longest Running SQL in Last Snapshot</b></font><hr align="left" width="600">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● html格式的Top SQL by Elapsed Time报告</b></font><hr align="left" width="450"> 
prompt 
prompt <center>[<a class="noLink" href="#sql_elasled_lastlongsqllink"><font size=+1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：执行Time最长的一条SQL报告</b></font></a>]</center><p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Top SQL by Elapsed Time</b></font><hr align="left" width="600">

prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 在gv$sql_monitor中，按照TimeSort取10条记录</font></b>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>执行Time最长的SQL报告</b></font><hr align="left" width="600">

prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 11g之前不Check该项，在v$sql_monitor中，取执行Time最长的一个sql </b>
prompt 

CLEAR COLUMNS COMPUTES
SET DEFINE ON
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: SQL脚本： SELECT dbms_sqltune.report_sql_monitor(sql_id  => &_sqlid1,type  => 'text',report_level => 'all') FROM dual; </font></b>
prompt  
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● html格式的sql_monitor报告</b></font><hr align="left" width="450"> 
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 11g之前不Check该项</font></b>
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 请复制如下的代码到txtFile中，然后另存为htmlFile，在有外网且可以ping通download.oracle.com的Overview下打开 </font></b>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>SQL Queries Without Bind Variables</b></font><hr align="left" width="600">
...
host echo "            FlashbackArchiving. . ." 
prompt <a name="link_dba_flashback_archive"></a>
prompt <font size="+2" color="00CCFF"><b>FlashbackArchiving</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="link_dba_flashback_archiveinfo"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>FlashbackArchivingConfiguration</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>EnabledFlashbackArchiving的表</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Flashback & Archiving Space</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
host echo "            DGLibraries. . ." 
prompt <a name="link_dginfo"></a>
SET DEFINE ON
prompt <font size="+2" color="00CCFF"><b>DGLibraries( &_DGINFO2 )</b></font><hr align="left" width="800">
prompt <p>



prompt <a name="link_dg_config"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DGLibrariesConfiguration Settings</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DGLibrariesExecutionOverview</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>主LibrariesDGProcess</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>主Librariesstandby日志</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DG其它Info</b></font><hr align="left" width="600">
...
host echo "start...DatabaseLibraries安全. ."  


prompt <a name="database_security"></a>
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b><u>DatabaseLibraries安全</u></b></font></center>
prompt <p>
...
-- |                             - USER ACCOUNTS -                              |
-- +----------------------------------------------------------------------------+
host echo "            DatabaseLibrariesUser. . ." 
prompt <a name="database_userinfo"></a>
prompt <font size="+2" color="00CCFF"><b>DatabaseLibrariesUser</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="user_accounts"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DatabaseLibrariesUser一览</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>拥有DBA角色的User</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>拥有SYS角色的User</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>角色概况</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>密码为系统Default Value的User</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>整个User有多大</b></font><hr align="left" width="600">
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 已排除回收站中的对象，排除了UNDO对象 </font></b>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>近一周登录Errors的User</b></font><hr align="left" width="600">
...
-- +----------------------------------------------------------------------------+
-- |             - 将系统TableSpace为缺省TableSpace的User         -                   |
-- +----------------------------------------------------------------------------+
host echo "            系统TableSpaceUser. . ." 
prompt <a name="database_systemuserinfo"></a>
prompt <font size="+2" color="00CCFF"><b>系统TableSpaceUser</b></font><hr align="left" width="800">
prompt <p>


prompt <a name="users_with_default_tablespace_defined_as_system"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>SYSTEM为缺省TableSpace的User</b></font><hr align="left" width="600">
...
-- +----------------------------------------------------------------------------+
-- |          - 将系统TableSpace为临时TableSpace的User                   -            |
-- +----------------------------------------------------------------------------+

prompt <a name="users_with_default_temporary_tablespace_as_system"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>SYSTEM为临时TableSpace的User</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DatabaseLibraries审计</b></font><hr align="left" width="600">

prompt <a name="database_audit_parameter"></a>
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>审计ParameterConfiguration</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>审计表Overview</b></font><hr align="left" width="450">
...
SELECT '<textarea style="width:100%;font-family:Courier New;font-size:12px;overflow:auto" rows="10"> ' || '在日常的DatabaseLibraries维护中，经常出现因为DatabaseLibraries登录审计的功能启动,导致SYSTEMTableSpace被用满.From而出现异常,一般Advisor把AUD$相关对象迁移到其他TableSpace,From而避免SYSTEM被用完的风险. '||'
-----10G及以前迁移方法      '||'
...
END;  '||'
/' ||  '</textarea>' 移动AUD$所在TableSpace FROM dual;  
SET MARKUP html TABLE  'width="auto" border="1" cellspacing="0px" style="border-collapse:collapse;" '
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DB中All审计记录</b></font><hr align="left" width="450">
...
-- +----------------------------------------------------------------------------+
-- |                  - 系统TableSpace中非系统User对象 -                            |
-- +----------------------------------------------------------------------------+

prompt <a name="objects_in_the_system_tablespace"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>系统TableSpace上的对象</b></font><hr align="left" width="600">
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: Excluding all internal system schemas (i.e. CTXSYS, MDSYS, SYS, SYSTEM) </font></b>


prompt <a name="table_sys_ts_infoall"></a>
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 系统TableSpace上的对象概况</b></font><hr align="left" width="450">
...
prompt <a name="table_sys_ts_infoall"></a>
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 系统TableSpace上的对象Details</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 哪些表建在系统TableSpace上</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 哪些Index建在系统TableSpace上</b></font><hr align="left" width="450">
...
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>][<a class="noLink" href="#segment_summary">下一项</a>]</center>
...
host echo "start...DatabaseLibraries对象. ." 
prompt <a name="db_objects"></a>
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b><u>DatabaseLibraries对象</u></b></font></center>
prompt <p>
...
prompt <font size="+2" color="00CCFF"><b>段Overview</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="object_summary"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>对象汇总</b></font><hr align="left" width="600">
...
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>][<a class="noLink" href="#database_segmentsinfo">上一项</a>]</center><p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>段的汇总</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>体积最大的10个段</b></font><hr align="left" width="600">

prompt <b><font color="#990000">●  以段为维度计算</font></b>
...
prompt <b><font color="#990000">●  以对象为维度计算</font> </b>
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <b><font color="#990000">●  以TableSpace为维度计算，取EveryTableSpace的前3张大表</font> </b>
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>扩展最多的10个段</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>LOB段</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>不能扩展的对象</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>扩展超过1/2最大扩展度的对象</b></font><hr align="left" width="600">
...
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b><u>Undo 段</u></b></font></center>
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Undo SegmentsDetails</b></font><hr align="left" width="450">
 
prompt <b>● AllUNDO段全部记录，可能在恢复中用到</b>
...
--SELECT * FROM v$rollname;  只能显示CurrentInstance的
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>TableSpaceOwner</b></font><hr align="left" width="600">
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: Excluding all internal system schemas (i.e. CTXSYS, MDSYS, SYS, SYSTEM) </font> </b>
...
prompt <font size="+2" color="00CCFF"><b>表Overview</b></font><hr align="left" width="800">
prompt <p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>行链接或行迁移的表</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>超过10W行无主键的表</b></font><hr align="left" width="600">
...
prompt 
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 只取Database量最大的前50张表 </font></b> 
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>无Database有高水位的表</b></font><hr align="left" width="600">
...
host echo "            分区表Overview. . ." 
prompt <a name="database_parttableinfo"></a>
prompt <font size="+2" color="00CCFF"><b>分区表Overview</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="nopart_table10g"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>表大小超过10GB未建分区的</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>分区最多的前10个对象</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>分区Count超过100个的表</b></font><hr align="left" width="600">
...
prompt <font size="+2" color="00CCFF"><b>Invalid Objects</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="invalid_objects"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>无效的对象</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>无效的普通Index</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>无效的分区Index</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>无效的触发Server</b></font><hr align="left" width="600">
...
host echo "            IndexOverview. . ." 
prompt <a name="database_indexinfo"></a>
prompt <font size="+2" color="00CCFF"><b>IndexOverview</b></font><hr align="left" width="800">
prompt <p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Tables with More Than 5 Indexes</b></font><hr align="left" width="600">

prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 只取IndexCount最多的前50张表 </font></b>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>大表未建Index</b></font><hr align="left" width="600">
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 大于2G大表未建Index</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 大于2GB的分区表未建任何Index</b></font><hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b> Group合Index与单列Index存在交叉</b></font><hr align="left" width="600">

prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 只取Top100 </font></b>
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>位图Index和函数Index</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>外键未建Index</b></font><hr align="left" width="600">
...
host echo "                大IndexFrom未使用. . . ."
prompt <a name="big_index_never_use"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>大IndexFrom未使用</b></font><hr align="left" width="600">

prompt <font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 查找大于1M的Index，在 Snapshot期间内From未使用过，取大小TOP50 


CLEAR COLUMNS COMPUTES
SET DEFINE OFF
--COLUMN count_index_cols       FORMAT a75    HEADING 'Index列的Count'       ENTMAP OFF
...
host echo "                Index列Count大于3. . . ."
prompt <a name="index_cols_counts"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Index列Count大于3</b></font>[<a class="noLink" href="#index_cols_high">下一项</a>]<hr align="left" width="600">

prompt <font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 复合IndexIndex列的Count一般为3个，超过3个需要Check其合理性 


CLEAR COLUMNS COMPUTES
SET DEFINE OFF
--COLUMN IND_COLS_COUNT       FORMAT a75    HEADING 'Index列的Count'       ENTMAP OFF
...
SELECT TABLE_OWNER,
  ...
  FROM (SELECT di.con_id,
               ...
               DIS.STALE_STATS,
               di.BLEVEL Index的分支层数,
               di.blevel + 1 Index的高度,
               di.LEAF_BLOCKS 叶子结点的Count,
               di.DISTINCT_KEYS 唯一Value的Count,
               di.AVG_LEAF_BLOCKS_PER_KEY EveryKEY的平均叶块Count,
               di.AVG_DATA_BLOCKS_PER_KEY EveryKEY的平均Database块数,
               di.clustering_factor Set群因子,
               di.compression,
               di.logging
          FROM CDB_indexes di
...
host echo "                Index高度大于3. . . ."
prompt <a name="index_cols_high"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Index高度大于3</b></font><hr align="left" width="600">

prompt <font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: Index的高度大于3的时候需要考虑If重建Index


CLEAR COLUMNS COMPUTES
SET DEFINE OFF
--COLUMN IND_COLS_COUNT11       FORMAT a75    HEADING 'Index列的Count'       ENTMAP OFF
COLUMN PARTITIONED       FORMAT a11    HEADING 'PARTITIONED'       ENTMAP OFF
COLUMN IS_PRIMARY_KEY       FORMAT a15    HEADING 'IS_PRIMARY_KEY'       ENTMAP OFF
COLUMN LAST_ANALYZED   FORMAT a140    HEADING '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;LAST_ANALYZED&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'  ENTMAP OFF
COLUMN INDEX_CREATE   FORMAT a140    HEADING '&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;INDEX_CREATE&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;'  ENTMAP OFF
...
host echo "                Index的StatisticsInfo过旧. . . ."
prompt <a name="index_cols_STALE_STATS"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Index的StatisticsInfo过旧</b></font>[<a class="noLink" href="#database_parallelinfo">下一项</a>]<hr align="left" width="600">

prompt <font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: Index的StatisticsInfo过旧
...
prompt <font size="+2" color="00CCFF"><b>并行度</b></font><hr align="left" width="800">
prompt <p>


prompt <a name="table_parallel"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>表带有并行度</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Index带有并行度</b></font><hr align="left" width="600">
...
prompt <font size="+2" color="00CCFF"><b>其他对象</b></font><hr align="left" width="800">
prompt <p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>告警日志</b></font><hr align="left" width="600">


SET DEFINE OFF
SET DEFINE ON
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 告警日志：&_ALERTLOG_PATH </font> </b>
prompt



prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Check近一周内最新的200行告警日志记录</b></font>[<a class="noLink" href="#altet_100">下一项</a>]<hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Check近一月内最新的100行告警日志记录(排除日志切换)，按照Time倒序排列</b></font><hr align="left" width="450">
...
-------Check最新的10条ora告警日志记录
prompt 　
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Check近一月内最新的10条ora告警日志记录，按照Time倒序排列</b></font><hr align="left" width="450">
...
-------告警日志File预估大小，经测试1W行大约0.5M
prompt 　
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 告警日志File预估大小</b></font><hr align="left" width="450">
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 告警日志File若太大会影响DatabaseLibraries的性能，Advisor定时Backup告警日志，大小为估算Value可能不准确 </font></b>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DatabaseLibrariesDirectory</b></font><hr align="left" width="600">
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DatabaseLibrariesDirectory概览</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Directory权限</b></font><hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>回收站Overview</b></font><hr align="left" width="600">


-- BREAK ON report ON owner
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 回收站中对象的大小</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 回收站中最早的10个对象</b></font><hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DatabaseLibraries链路</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>外部表</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>All的触发Server</b></font><hr align="left" width="600">
prompt  
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 总体Overview</b></font><hr align="left" width="450">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 详细Overview，按照User，EveryUser取前10行</b></font><hr align="left" width="450">
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: Excluding all internal system schemas (i.e. CTXSYS, MDSYS, SYS, SYSTEM)</font> </b>
SELECT *
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● database级别的触发Server</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● DISABLED的触发Server</b></font><hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>序列cache小于20</b></font><hr align="left" width="600"> 
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 序列cache小于20,若发生序列等待，一般Overview下将其增至1000左右，序列默认的20太小了</b></font><hr align="left" width="450">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 序列AUDSES$的Overview，同一Time多个会话连接会发生 </font></b>
SELECT * FROM cdb_sequences d WHERE d.sequence_name ='AUDSES$' order by con_id; 

prompt   
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 历史WaitEvent中If有序列等待，该部分的序列强烈Advisor修改其cacheValue </b></font><hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>物化View</b></font><hr align="left" width="600">
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 物化View相关的Parameter</b></font><hr align="left" width="450">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● All物化View</b></font><hr align="left" width="450">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 只取前500行 </font> </b>
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
host echo start...DatabaseLibraries性能分析. . 


prompt <a name="database_performacefenxi"></a>
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b><u>DatabaseLibraries性能分析</u></b></font></center>
prompt <p>
...
COLUMN snap_time        	 FORMAT a22                    HEADING 'StatisticsTime'        ENTMAP OFF
COLUMN mem_read            FORMAT 999,999,999,999,999    HEADING 'Memory读(MB)'     ENTMAP OFF
COLUMN disk_read           FORMAT 999,999,999,999,999    HEADING 'Disk读(MB)'         ENTMAP OFF
COLUMN disk_write          FORMAT 999,999,999,999,999    HEADING 'Disk写(KB)'         ENTMAP OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>AWRParameterConfiguration状况</b></font><hr align="left" width="600">


prompt <font face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● Current状态</b></font>
...
prompt <font face="Courier New,Helvetica,Geneva,sans-serif"> 启用AWR需要满足如下3个条件： </font>
prompt <font face="Courier New,Helvetica,Geneva,sans-serif"> ① STATISTICS_LEVEL的Value为TYPICAL或者 ALL </font>
prompt <font face="Courier New,Helvetica,Geneva,sans-serif"> ② SELECT * FROM dba_hist_wr_control 中，snap_interval不能无穷大，一般exec DBMS_WORKLOAD_REPOSITORY.MODIFY_SNAPSHOT_SETTINGS(INTERVAL => 60); </font>
prompt <font face="Courier New,Helvetica,Geneva,sans-serif"> ③ SELECT SYSDATE - d.end_interval_time FROM   dba_hist_snapshot d WHERE  d.snap_id = (SELECT MAX(snap_id) FROM dba_hist_snapshot); 需大于0，若是小于0可以手动生成几次 Snapshot来解决这个问题：exec dbms_workload_repository.create_snapshot(); </font>
...
prompt
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 历史状态(取近7天的 Snapshot，只取前50行记录)</b></font>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>DatabaseLibrariesServiceServerHost的Overview</b></font><hr align="left" width="600">


prompt <center>[<a class="noLink" href="#awr_host_info"><font size=+1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：DatabaseLibrariesServiceServerHost的Overview</b></font></a>]</center><p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>AWRView中的load profile</b></font><hr align="left" width="600">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 近7天以来AWRView中的load profileInfo </font> </b>
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>最新的一次AWR报告</b></font><hr align="left" width="600">

SET DEFINE ON
prompt  SELECT * FROM table(dbms_workload_repository.awr_report_html(&_dbid,&_instance_number,&_snap_id,&_snap_id1));
prompt 
prompt <center>[<a class="noLink" href="#awr_new_lastone_link"><font size=+1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：最新的一次AWR报告</b></font></a>]</center><p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>ASH Snapshot状况</b></font><hr align="left" width="600">

prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 历史状态(取近7天的 Snapshot)</b></font>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>最新的一次ASH报告</b></font><hr align="left" width="600">

SET DEFINE ON
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: SQL脚本 ： SELECT * FROM table(dbms_workload_repository.ash_report_html(&_dbid,&_instance_number,(SELECT a.end_interval_time FROM dba_hist_ash_snapshot a WHERE a.snap_id = &_ash_snap_id AND  a.INSTANCE_NUMBER= &_instance_number ),(SELECT a.end_interval_time FROM dba_hist_ash_snapshot a WHERE a.snap_id = &_ash_snap_id1 AND  a.INSTANCE_NUMBER= &_instance_number))); </font>  </b>

prompt
prompt <center>[<a class="noLink" href="#ASH_new_lastone"><font size=+1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>DatabaseRefrence：ASHDatabase</b></font></a>]</center><p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>最新的一次ADDM</b></font><hr align="left" width="600"> 
...
prompt 
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>:　SQL脚本： SELECT dbms_advisor.get_task_report('HEALTH_CHECK_BY_LHR', 'TEXT', 'ALL') addm_results  FROM DUAL; </font></b>
...
prompt 
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 英文版ADDM </font></b>  [<a class="noLink" href="#hot_blocks_summary">下一项</a>] [<a class="noLink" href="#directory">Return to Directory</a>]<p>
...
--prompt <center>[<a class="noLink" href="#ADDM_new_lastone"><font size=+1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>DatabaseRefrence：ADDMDatabase</b></font></a>]</center><p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>热块</b></font><hr align="left" width="600">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 该部分需要sysUser赋予CheckUser对x$bh的Query权限，SQL: CREATE OR REPLACE VIEW bh AS SELECT * FROM sys.x$bh;  create or replace public synonym x$bh for bh;</font></b>
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 该部分若执行过慢，可以先收Set系统StatisticsInfo后再执行：exec dbms_stats.gather_dictionary_stats; exec dbms_stats.gather_fixed_objects_stats;</font></b>
prompt 
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 热块(汇总)</b></font>
...
prompt 
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 热块(展开，未汇总）</b></font> 
...
host echo "            StatisticsInfo. . ." 

prompt 
prompt <a name="database_tjxinxiinfo"></a>
prompt <font size="+2" color="00CCFF"><b>StatisticsInfo</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="statics_gatherflag"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>StatisticsInfoIf自动收Set</b></font><hr align="left" width="600">
prompt ● Oracle 10g的默认Time窗口为：Every工作日的晚上10点到第二天凌晨6点，持续8小时；All的周末Time即周末全天收Set（周五晚上10点到周一凌晨6点）。
prompt ● Oracle 11g及其之后的Version的默认Time窗口为：Every工作日的晚上10点到第二天凌晨2点，持续4小时；Every周六上午6点到周日凌晨2点，周日上午6点到周一凌晨2点，都是持续20个小时。
...
prompt ● 自动收SetStatisticsInfo的详细Info
...
prompt ● 自动收SetStatisticsInfo的JOBExecutionErrors日志
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>需收SetStatisticsInfo的表</b></font> [<a class="noLink" href="#statics_gatherfla_tmptable">下一项</a>] <hr align="left" width="600">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: From未收Set过StatisticsInfo的表或者1个月内没有收Set过StatisticsInfo的表 </font></b>
prompt  
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 总体状况 </b></font><hr align="left" width="450">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt  
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 详细Overview </b></font><hr align="left" width="450">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 1月内未收SetStatisticsInfo的表只取前100张，取All未收SetStatisticsInfo的表</font></b>
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>被收SetStatisticsInfo的临时表</b></font>[<a class="noLink" href="#statics_gatherfla_table">上一项</a>]</center><p><hr align="left" width="600"> 
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>StatisticsInfo被锁的表或Index</b></font>[<a class="noLink" href="#statics_gatherfla_table">上一项</a>]</center><p><hr align="left" width="600"> 
...
prompt <font size="+2" color="00CCFF"><b>会话</b></font><hr align="left" width="800">
prompt <p>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>会话概况(Current)</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>会话状态一览(Current)</b></font><hr align="left" width="600">
...
host echo "                历史ACTIVE会话数. . . ." 
prompt <a name="user_session_active_his"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>历史ACTIVE会话数 </b></font><hr align="left" width="600">

prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 历史ACTIVE会话数(按照 Snapshot展示) </b></font><hr align="left" width="450">
...
prompt
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 历史ACTIVE会话数(按照小时展示) </b></font><hr align="left" width="450">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>登录Time最长的10个会话</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>超过10小时无响应的会话</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>CommitTimes最多的会话</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>30分钟内CPU或等待最长的会话</b></font><hr align="left" width="600">
...
prompt <font size="+2" color="00CCFF"><b>锁</b></font><hr align="left" width="800">
prompt <p>



prompt <a name="look_lock"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>CheckLOCK锁Overview</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>CheckWho锁住了Who</b></font><hr align="left" width="600">
...
prompt <font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 常用的与锁有关的Database字典View有DBA_DML_LOCKS、DBA_DDL_LOCKS、V$LOCK、DBA_LOCK、V$LOCKED_OBJECT。V$LOCKED_OBJECT记录的是DML锁Info，而没有记录DDL锁。V$LOCK和DBA_LOCKS和DBA_LOCKContent一样，DBA_LOCKS是DBA_LOCK的同义词。 </font>
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>CursorUsage</b></font><hr align="left" width="600">
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>并行Process完成Overview</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" color="00CCFF"><b>Memory占用</b></font><hr align="left" width="800">
prompt <p>



prompt <a name="rate_db_object_cache"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Query共享Memory占有率</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>PGA占用最多的Process</b></font><hr align="left" width="600">
...
prompt <font size="+2" color="00CCFF"><b>命中率</b></font><hr align="left" width="800">
prompt <p>



prompt <a name="buffer_cache_ratiosss"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>buffer cache 命中率</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>librarycache命中率</b></font><hr align="left" width="600">
prompt NOTE: 若低于95%，则需要调整应用程序使用绑定变量，或者调整DatabaseLibrariesParametershared_pool_size的大小
...
prompt <a name="buffer_cache_ratiosss"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>Database字典缓冲区命中率</b></font><hr align="left" width="600">
CLEAR COLUMNS COMPUTES
SET DEFINE OFF
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>latch的命中率</b></font><hr align="left" width="600">
...
prompt <font size="+2" color="00CCFF"><b>其它</b></font><hr align="left" width="800">
prompt <p>

prompt <a name="wait_event_current"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>WaitEvent</b></font><hr align="left" width="600">
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● WaitEvent（Current）</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● WaitEvent（cdb_hist_active_sess_history）</b></font><hr align="left" width="450">
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 非空闲WaitEvent（历史汇Set）</b></font><hr align="left" width="450">
...
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b><u>HealthCheck报告结果</u></b></font></center>
 
 
prompt <a name="health_check_summary_info_details"></a>
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>HealthCheck报告结果</b></font><hr align="left" width="600">
...
SELECT '<div align="center">' || rownuM || '</div>' ID,
  ...
  FROM (select SUBSTR(health_check_results,
          ...
          from (select case
                         when (SELECT COUNT(1)
                          ...
                          (select 1 || '|' || 5 || '|' || 'InspectionServiceOverview.Parameter Files' || '|' ||
                                  'DatabaseLibraries未使用spfileFile，强烈推荐CreationspfileFile' || '|' ||
                                  '<center>[<a class="noLink" href="#initialization_parameters"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：All Initialization Parameters</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                ...
                select case
                         when (SELECT SUM(COUNTS)
                          ...
                          (select 2 || '|' || 1 || '|' || 'InspectionServiceOverview.Tablespace Status.Data Files状况' || '|' ||
                                  'DatabaseLibraries里有OFFLINE状态的Data Files，Advisor立刻修复该问题' || '|' ||
                                  '<center>[<a class="noLink" href="#data_files"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：Data Files状况</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
                select case
                         when (SELECT COUNT(1)
                          ...
                          (select 3 || '|' || 3 || '|' || 'InspectionServiceOverview.ASMDiskMonitor' || '|' ||
                                  'Insufficient ASM disk space' || '|' ||
                                  '<center>[<a class="noLink" href="#asm_diskgroup"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：ASMDiskGroupUsage</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
                select case
                         when (SELECT SUM(COUNTS)
                          ...
                          (select 4 || '|' || 5 || '|' || 'InspectionServiceOverview.JOBOverview' || '|' ||
                                  '近一个月内JOB有Errors出现，请CheckIf有影响业务Database的JOB' || '|' ||
                                  '<center>[<a class="noLink" href="#jobs_info"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：JobExecution状况</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
                select case
                         when (SELECT count(1) FROM v$backup_set) < 2 then
                          (select 5 || '|' || 2 || '|' || 'InspectionServiceDetails.RMANInfo' || '|' ||
                                  'DatabaseLibraries无RMANBackupInfo，强烈Advisor对DatabaseLibraries进行Backup' || '|' ||
                                  '<center>[<a class="noLink" href="#database_rmanbackinfo"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：RMANInfo</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
                select case
                         when (select count(*)
                          ...
                          (select 6 || '|' || 2 || '|' ||
                                  'InspectionServiceDetails.SQLMonitor.SQL Queries Without Bind Variables' || '|' ||
                                  'SQL Queries Without Bind Variables会引起librarycache命中率降低，降低系统性能' || '|' ||
                                  '<center>[<a class="noLink" href="#sql_no_bind"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：SQL Queries Without Bind Variables</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                ...
                select case
                         when (SELECT COUNT(*)
                          ...
                          (select 7 || '|' || 2 || '|' || 'InspectionServiceDetails.DGLibraries' || '|' ||
                                  'DatabaseLibrariesDGLibrariesExecution不正常，请点击右边连接CheckDGLibraries的Details' || '|' ||
                                  '<center>[<a class="noLink" href="#link_dginfo"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：DGLibraries</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                ...
                select case
                         when (SELECT COUNT(1)
                          ...
                          (select 8 || '|' || 4 || '|' || 'DatabaseLibraries对象.Invalid Objects' || '|' ||
                                  'DatabaseLibraries里有无效的对象，Advisor重新编译' || '|' ||
                                  '<center>[<a class="noLink" href="#database_invalidobjects"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：Invalid Objects</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                ...
                select case
                         when (SELECT COUNT(1)
                          ...
                          (select 9 || '|' || 4 || '|' || 'DatabaseLibraries对象.其他对象.回收站Overview' || '|' ||
                                  '回收站有无用对象' || '|' ||
                                  '<center>[<a class="noLink" href="#dba_recycle_bin"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：回收站Overview</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
                select case
                         when (SELECT COUNT(1)
                          ...
                          (select 10 || '|' || 2 || '|' ||
                                  'DatabaseLibraries对象.其他对象.序列cache小于20' || '|' ||
                                  'DatabaseLibraries序列的cacheValue小于20，可能伴随有enq: SQ - contentionWaitEvent' || '|' ||
                                  '<center>[<a class="noLink" href="#sequence_cache_20"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>序列cache小于20</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
                select case
                         when (SELECT COUNT(1)
                          ...
                          (select 11 || '|' || 2 || '|' ||
                                  'DatabaseLibraries性能分析.会话.超过10小时无响应的会话' || '|' ||
                                  '超过10小时无响应的会话可以考虑将其kill掉来释放 Resources' || '|' ||
                                  '<center>[<a class="noLink" href="#long_nofanying"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：超过10小时无响应的会话</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
                select case
                         when (select count(*) from (SELECT g.inst_id,sum(pinhits) / sum(pins) FROM Gv$librarycache g group by g.inst_id having sum(pinhits) / sum(pins)<0.95)) >0 then
                          (select 12 || '|' || 2 || '|' || 'DatabaseLibraries性能分析.Memory占用.命中率' || '|' ||
                                  '低于 95%，则需要调整应用程序使用绑定变量，或者调整DatabaseLibrariesParametershared_pool_size的大小' || '|' ||
                                  '<center>[<a class="noLink" href="#library_cache_ratiosss"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：librarycache 整体命中率</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
 ...
 and round((a.all_bytes - b.FREESIZ) / a.all_bytes, 2) > 0.98) > 0 then
                          (select 13 || '|' || 1 || '|' ||
                                  'InspectionServiceOverview.Tablespace Status.TableSpace状况Info' || '|' ||
                                  '若TableSpace使用率大于98%，则考虑增加TableSpace的大小' || '|' ||
                                  '<center>[<a class="noLink" href="#tablespaces_info"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：TableSpace状况Info</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                UNION ALL
                select case
                         when (SELECT SUM(COUNTS)
                          ...
                          (select 14 || '|' || 2 || '|' ||
                                  'DatabaseLibraries性能分析.StatisticsInfo.StatisticsInfoIf自动收Set' || '|' ||
                                  'DatabaseLibraries的StatisticsInfo没有开启自动收Set功能，强烈Advisor开启该功能' || '|' ||
                                  '<center>[<a class="noLink" href="#statics_gatherflag"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：StatisticsInfoIf自动收Set</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
                ...
                select case
                         when (SELECT COUNT(*)
                          ...
                          (select 15 || '|' || 2 || '|' || 'DatabaseLibraries对象.其他对象.告警日志' || '|' ||
                                  'DatabaseLibraries告警日志有oraErrors，请详细Check告警日志Content' || '|' ||
                                  '<center>[<a class="noLink" href="#link_alert_log"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：告警日志</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
				  UNION ALL
                select case
                         when (SELECT COUNT(*) FROM v$pdbs a where a.OPEN_MODE in ('MOUNTED') or a.RESTRICTED='YES') > 0 then
                          (select 16 || '|' || 2 || '|' || 'Database General Overview.Basic Database Info.PDBOverview' || '|' ||
                                  'PDB状态不正确' || '|' ||
                                  '<center>[<a class="noLink" href="#pdb_overview"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：PDBOverview</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
				  UNION ALL 
                select case
                         when (SELECT COUNT(*) FROM V$CONTROLFILE a) < 2 then
                          (select 17 || '|' || 2 || '|' || 'InspectionServiceOverview.Tablespace Status.控制File' || '|' ||
                                  '控制File无双路镜像，Advisor对控制File镜像' || '|' ||
                                  '<center>[<a class="noLink" href="#control_files"><font size=1 face="Courier New,Helvetica,sans-serif" color="#336699"><b>Refrence：控制File</b></font></a>]</center><p>' CHECK_MESSAGE_DETAIL_LINK
                             from dual)
                       end
                  from dual
				  )
...
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>][<a class="noLink" href="#sqlscripts_errors">HealthCheck过程中脚本产生的Errors</a>]</center><p>
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 最新的一次AWR报告 </b></font><hr align="left" width="800">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: SQL脚本 ： SELECT * FROM table(dbms_workload_repository.awr_report_html(&_dbid,&_instance_number,&_snap_id,&_snap_id1));  </font></b>
prompt 　　 　　 　　 　　
...
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>][<a class="noLink" href="#awr_new_lastone">回到AWR</a>]</center><p>




host echo 生成最新的一次ASH报告....
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 最新的一次ASH报告 </b></font><hr align="left" width="800">

 
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: SQL脚本 ： SELECT * FROM table(dbms_workload_repository.ash_report_html(&_dbid,&_instance_number,(SELECT a.end_interval_time FROM dba_hist_ash_snapshot a WHERE a.snap_id = &_ash_snap_id),(SELECT a.end_interval_time FROM dba_hist_ash_snapshot a WHERE a.snap_id = &_ash_snap_id1))); </font> </b>
prompt 　　 　　 　　 　　
...
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>] [<a class="noLink" href="#ash_lastone_info">回到ASH</a>]</center><p>
...
prompt <font size="+1" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>● 执行Time最长的一条SQL报告 </b></font><hr align="left" width="800">


prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: SQL脚本 ： SELECT * FROM table(dbms_workload_repository.awr_sql_report_html(&_dbid,&_instance_number, &_snap_id,&_snap_id1, &_sqlid)) ; </font> </b>
prompt 　　 　　 　　 　　

SELECT * FROM table(dbms_workload_repository.awr_sql_report_html(&_dbid,&_instance_number, &_snap_id,&_snap_id1, &_sqlid));

prompt 　　 　　 　　 　　
prompt <center>[<a class="noLink" href="#directory">Return to Directory</a>] [<a class="noLink" href="#sql_elasled_lastlongsql">回到SQL部分</a>]</center><p>



host echo DatabaseLibraries脚本执行结束....
...
prompt <center><font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#663300"><b>DatabaseLibrariesInspectionService报告结束</b></font></center>

prompt
prompt <b><font face="Courier New"><font face="Courier New,Helvetica,sans-serif" color="#990000">NOTE</font>: 结束Time：&_date_time_end </font> </b>
prompt
...
prompt <font size="+2" face="Courier New,Helvetica,Geneva,sans-serif" color="#336699"><b>HealthCheck过程中脚本产生的Errors<hr align="left" width="450">
prompt <font size="1" face="Courier New,Helvetica,Geneva,sans-serif" color="#990000">NOTE: 该部分Content不属于HealthCheck报告的Content，只作为执行者调试脚本使用，个别报错属于正常现象</font>
...
prompt <font size="+0.5"><center>[<a class="noLink" href="#directory">Return to Directory</a>][<a class="noLink" href="#health_check_summary_info_details">HealthCheck报告结果</a>]</center><p></font>
...
prompt 
prompt InspectionReport生成到CurrentDirectory下(请确保CurrentOSUser对CurrentDirectory具有可写权限): &_reporttitle..html
prompt Inspection脚本执行结束！
